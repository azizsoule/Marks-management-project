...
if (isset($_GET["etudiant"]) && isset($_GET["op"]) && $_GET["op"]=="u") {

    $etudiant = EtudiantQuery::create()->findPk($_GET["etudiant"]);
                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="?etudiant=<?php if(isset($etudiant)) echo $etudiant->getId(); ?>&op=u" class="form-horizontal" method="post">

                                        <div class="form-group">
                                            <label for="default" class="col-sm-2 control-label">Nom</label>
                                            <div class="col-sm-10">
                                                <input value="<?php if(isset($etudiant)) echo $etudiant->getNom(); ?>" type="text" name="lastname" class="form-control" id="fullanme"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="<?php if(isset($etudiant)) echo $etudiant->getPrenoms(); ?>" type="text" name="firstname" class="form-control" id="fullanme"
                                                       required="required" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="<?php if(isset($etudiant)) echo $etudiant->getDatenaissance()->format('Y-m-d'); ?>" type="date" name="date_naiss" class="form-control" id="rollid"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="<?php if(isset($etudiant)) echo $etudiant->getEmail(); ?>" type="email" name="email" class="form-control" id="email"
                                                       required="required" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                foreach ($genders as $gender) {
                                                    ...
                                                    if (isset($etudiant) && $gender->getId()==$etudiant->getGenre()->getId()) {
                                                        echo '<input checked="" type="radio" name="genre" value="'.$gender->getId().'" required="required"> '.$gender->getLibelle().' ';
                                                    } else {
                                                        echo '<input type="radio" name="genre" value="'.$gender->getId().'" required="required"> '.$gender->getLibelle().' ';
                                                    }
                                            ...
                                            <div class="col-sm-10">
                                                <select name="level" class="form-control" id="default" required="required">
                                                    ...
                                                    foreach ($levels as $level) {
                                                        ...
                                                        if (isset($etudiant) && $etudiant->getNiveau()->getId()==$level->getId()) {
                                                            echo '<option selected value="'.$level->getId().'">'.$level->getLibelle().'</option>';
                                                        } else {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="<?php if(isset($etudiant)) echo $etudiant->getContact(); ?>" required type="tel" name="contact" class="form-control" id="date">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" name="submit" class="btn btn-primary">Modifier étudiant</button>
                                            </div>
                                        </div>
                                    </form>
