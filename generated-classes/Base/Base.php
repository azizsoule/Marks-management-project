...
/**
 * Base class that represents a row from the 'base' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Base implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BaseTableMap';
    ...
    /**
     * Initializes internal state of Base\Base object.
     */
    ...
    /**
     * Compares this with another <code>Base</code> instance.  If
     * <code>obj</code> is an instance of <code>Base</code>, delegates to
     * <code>equals(Base)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Base The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BaseTableMap::COL_ID] = true;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[BaseTableMap::COL_LIBELLE] = true;
        }
    ...
    public function setValeur($v)
    {
        ...
        if ($this->valeur !== $v) {
            $this->valeur = $v;
            $this->modifiedColumns[BaseTableMap::COL_VALEUR] = true;
        }
    ...
    public function setCoef($v)
    {
        ...
        if ($this->coef !== $v) {
            $this->coef = $v;
            $this->modifiedColumns[BaseTableMap::COL_COEF] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BaseTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BaseTableMap::translateFieldName('Libelle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->libelle = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BaseTableMap::translateFieldName('Valeur', TableMap::TYPE_PHPNAME, $indexType)];
            $this->valeur = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BaseTableMap::translateFieldName('Coef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coef = (null !== $col) ? (double) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = BaseTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Base'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBaseQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBaseQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BaseTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BaseTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BaseTableMap::COL_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = 'libelle';
        }
        if ($this->isColumnModified(BaseTableMap::COL_VALEUR)) {
            $modifiedColumns[':p' . $index++]  = 'valeur';
        }
        if ($this->isColumnModified(BaseTableMap::COL_COEF)) {
            $modifiedColumns[':p' . $index++]  = 'coef';
        }

        $sql = sprintf(
            'INSERT INTO base (%s) VALUES (%s)',
    ...
    {
        $pos = BaseTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Base'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Base'][$this->hashCode()] = true;
        $keys = BaseTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setValeur($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setCoef($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Base The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BaseTableMap::COL_ID)) {
            $criteria->add(BaseTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BaseTableMap::COL_LIBELLE)) {
            $criteria->add(BaseTableMap::COL_LIBELLE, $this->libelle);
        }
        if ($this->isColumnModified(BaseTableMap::COL_VALEUR)) {
            $criteria->add(BaseTableMap::COL_VALEUR, $this->valeur);
        }
        if ($this->isColumnModified(BaseTableMap::COL_COEF)) {
            $criteria->add(BaseTableMap::COL_COEF, $this->coef);
        }
    ...
    {
        $criteria = ChildBaseQuery::create();
        $criteria->add(BaseTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Base (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Base Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildBase is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBase The current object (for fluent API support)
     */
     ...
     * Otherwise if this Base is new, it will return
     * an empty collection; or if this Base has previously
     * been saved, it will retrieve related Notes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Base.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(BaseTableMap::DEFAULT_STRING_FORMAT);
    }
