...
/**
 * Base class that represents a row from the 'ecue' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Ecue implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EcueTableMap';
    ...
    /**
     * Initializes internal state of Base\Ecue object.
     */
    ...
    /**
     * Compares this with another <code>Ecue</code> instance.  If
     * <code>obj</code> is an instance of <code>Ecue</code>, delegates to
     * <code>equals(Ecue)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Ecue The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EcueTableMap::COL_ID] = true;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[EcueTableMap::COL_LIBELLE] = true;
        }
    ...
    public function setCredits($v)
    {
        ...
        if ($this->credits !== $v) {
            $this->credits = $v;
            $this->modifiedColumns[EcueTableMap::COL_CREDITS] = true;
        }
    ...
    /**
     * Set the value of [idue] column.
     *
     * @param int $v New value
     * @return $this|\Ecue The current object (for fluent API support)
     */
    public function setIdue($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->idue !== $v) {
            $this->idue = $v;
            $this->modifiedColumns[EcueTableMap::COL_IDUE] = true;
        }

        if ($this->aUe !== null && $this->aUe->getId() !== $v) {
            $this->aUe = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EcueTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EcueTableMap::translateFieldName('Libelle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->libelle = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EcueTableMap::translateFieldName('Credits', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credits = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EcueTableMap::translateFieldName('Idue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idue = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = EcueTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Ecue'), 0, $e);
        }
    }
    ...
    {
        if ($this->aUe !== null && $this->idue !== $this->aUe->getId()) {
            $this->aUe = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEcueQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEcueQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EcueTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aUe !== null) {
                if ($this->aUe->isModified() || $this->aUe->isNew()) {
                    $affectedRows += $this->aUe->save($con);
                }
                $this->setUe($this->aUe);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EcueTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EcueTableMap::COL_LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = 'libelle';
        }
        if ($this->isColumnModified(EcueTableMap::COL_CREDITS)) {
            $modifiedColumns[':p' . $index++]  = 'credits';
        }
        if ($this->isColumnModified(EcueTableMap::COL_IDUE)) {
            $modifiedColumns[':p' . $index++]  = 'idUe';
        }

        $sql = sprintf(
            'INSERT INTO ecue (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'credits':
                        ...
                        break;
                    case 'idUe':
                        $stmt->bindValue($identifier, $this->idue, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = EcueTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Ecue'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Ecue'][$this->hashCode()] = true;
        $keys = EcueTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getLibelle(),
            $keys[2] => $this->getCredits(),
            $keys[3] => $this->getIdue(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aUe) {
                ...
                $result[$key] = $this->aUe->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setCredits($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdue($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Ecue The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EcueTableMap::COL_ID)) {
            $criteria->add(EcueTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EcueTableMap::COL_LIBELLE)) {
            $criteria->add(EcueTableMap::COL_LIBELLE, $this->libelle);
        }
        if ($this->isColumnModified(EcueTableMap::COL_CREDITS)) {
            $criteria->add(EcueTableMap::COL_CREDITS, $this->credits);
        }
        if ($this->isColumnModified(EcueTableMap::COL_IDUE)) {
            $criteria->add(EcueTableMap::COL_IDUE, $this->idue);
        }
    ...
    {
        $criteria = ChildEcueQuery::create();
        $criteria->add(EcueTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Ecue (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Ecue Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildUe object.
     *
     * @param  ChildUe $v
     * @return $this|\Ecue The current object (for fluent API support)
     * @throws PropelException
     */
    public function setUe(ChildUe $v = null)
    {
        if ($v === null) {
            $this->setIdue(NULL);
        } else {
            $this->setIdue($v->getId());
        }

        $this->aUe = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildUe object, it will not be re-added.
        if ($v !== null) {
            $v->addEcue($this);
        }
    ...
    /**
     * Get the associated ChildUe object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildUe The associated ChildUe object.
     * @throws PropelException
     */
    public function getUe(ConnectionInterface $con = null)
    {
        if ($this->aUe === null && ($this->idue != 0)) {
            $this->aUe = ChildUeQuery::create()->findPk($this->idue, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUe->addEcues($this);
             */
        }
     ...
     * If this ChildEcue is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEcue The current object (for fluent API support)
     */
     ...
     * Otherwise if this Ecue is new, it will return
     * an empty collection; or if this Ecue has previously
     * been saved, it will retrieve related Notes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Ecue.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildNote[] List of ChildNote objects
     */
    public function getNotesJoinEtudiant(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildNoteQuery::create(null, $criteria);
        $query->joinWith('Etudiant', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(EcueTableMap::DEFAULT_STRING_FORMAT);
    }
