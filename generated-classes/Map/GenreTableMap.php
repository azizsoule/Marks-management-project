...
class GenreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.GenreTableMap';
     ...
     */
    const COL_ID = 'genre.id';

    /**
     * the column name for the libelle field
     */
    const COL_LIBELLE = 'genre.libelle';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(GenreTableMap::COL_ID, GenreTableMap::COL_LIBELLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(GenreTableMap::COL_ID => 0, GenreTableMap::COL_LIBELLE => 1, ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'genre.id' => 'ID',
        'GenreTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Libelle' => 'LIBELLE',
        'Genre.Libelle' => 'LIBELLE',
        'libelle' => 'LIBELLE',
        'genre.libelle' => 'LIBELLE',
        'GenreTableMap::COL_LIBELLE' => 'LIBELLE',
        'COL_LIBELLE' => 'LIBELLE',
    ];
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to genre     * by a foreign key with ON DELETE CASCADE
     */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GenreTableMap::COL_ID);
            $criteria->addSelectColumn(GenreTableMap::COL_LIBELLE);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(GenreTableMap::COL_ID);
            $criteria->removeSelectColumn(GenreTableMap::COL_LIBELLE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(GenreTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(GenreTableMap::COL_ID) && $criteria->keyContainsValue(GenreTableMap::COL_ID) ) {
